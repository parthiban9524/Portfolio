export const resumeData = {
  ...
  phone: "9524086370",
  email: "parthiban1082000@gmail.com",
  ...
  highlights: [
    ...
    "Android and iOS build and deployment support",
    "Payment, maps, push notification, and API integrations",
  ],
  skills: [
    {
      category: "Mobile Development",
      items: ["React Native CLI", "Functional Components", "React Hooks", "Android Studio", "Xcode"],
    },
    {
    ...
    },
    {
      ...
      items: ["Razorpay SDK", "Payment Gateway Integration", "Firebase Push Notifications", "REST APIs", "MQTT"],
    },
    {
      category: "Frontend",
      items: ["JavaScript ES6+", "HTML5", "CSS3", "Responsive UI"],
    },
    {
      category: "Tools and Workflow",
      items: ["Git", "Agile", "Scrum", "API Integration", "App Deployment"],
    },
  ],
  projects: [
    {
  ...
  experience: [
    {
      ...
      details: [
        "Worked on a B2B e-commerce application, building key UI modules and handling a multi-flavor architecture.",
        "Managed Android and iOS builds, supported deployment processes, and collaborated on API integration.",
        "Worked on Vigo App, Vigo Mart, and Commerce Lynk.",
      ],
    },
    {
      role: "Senior Mobile App Developer",
      company: "Hexwave Technologies",
      period: "Sep 2023 - Dec 2025",
      details: [
        "Worked on the PLUGNPE app as the sole developer for EV charging, roadside assistance, and charging station discovery.",
        "Used React Native CLI and functional components to integrate maps and Razorpay payment SDK.",
        "Implemented Firebase push notifications.",
      ],
    },
    {
      role: "React Native Developer",
      company: "TradeSocio Pvt Ltd",
    ...
    },
    {
      ...
      company: "Handbuilt Apps",
      period: "Jul 2021 - Apr 2022",
      details: [
        "Developed features and screens for IN THE CITY, CDA, and DOFE apps.",
        "Used React Native, hooks, and Redux-Saga across location-based and award progress tracking apps.",
        "Implemented UI components to improve the user experience.",
      ],
    },
  ],
  education: [
